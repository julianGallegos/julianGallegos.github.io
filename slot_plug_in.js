(function($){
    ...
    $.jSlots = function(el, options){
        ...
        $.jSlots.defaultOptions = {
            ...
            // winnerNumber : ,    // Number or Array: list item number(s) upon which to trigger a win, 1-based index, NOT ZERO-BASED
            spinner : '.slot_image',        // CSS Selector: element to bind the start event to
